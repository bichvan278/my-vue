<template>
  ...
  <div id="formContent">
    ...
    <form @submit.prevent="submitLogin">
      <input type="text" id="username" class="fadeIn second" v-model="user.username" name="username" placeholder="username">
      <input type="text" id="password" class="fadeIn third" v-model="user.password" name="password" placeholder="password">
